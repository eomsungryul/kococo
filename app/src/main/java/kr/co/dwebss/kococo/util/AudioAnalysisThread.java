 ...
 *
 * */
public class AudioAnalysisThread extends Thread{
//
...
//            String[] fileInfo = wfc.saveLongTermWave(fileName, v.getContext());
//
...
//            ans.addProperty("analysisFileNm",fileInfo[1]);JsonArray ansDList = new JsonArray();
